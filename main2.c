...
/*   Updated: 2017/12/14 15:50:30 by gauffret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	if (TEST_CRASH)
	{
		...
		//mr = ft_printf("MINE>\t[%C]\n","我");
		//or = printf("ORIG>\t[%C]\n", "我");
		//ft_print_result(mr, or, __LINE__); error malloc

		mr = ft_printf("MINE>\t[%S]\n", "我是一只猫。");
		or = printf("ORIG>\t[%S]\n", "我是一只猫。");
		ft_print_result(mr, or, __LINE__);

		printf("\e[38;5;6m\t\t== End Crashtest zone ==\033[0m\n\n");
	}
	if (0)
	{
	...
	if (INFINITY)
	{
		printf("\e[38;5;6m\t\t======== Infinite Loop ========\033[0m\n");
		while (1)
			;
	}
	return (0);
